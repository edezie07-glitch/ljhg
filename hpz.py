...
FULLY RENOVATED - ALL ISSUES FIXED!
"""
...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        'DATABASE_URL', 
        f'sqlite:///{os.path.join(BASEDIR, "hpz_database.db")}'
    )
...
def search_users():
    ...
    try:
        ...
        for user in users:
            ...
            last_seen = 'Online' if is_online else get_time_ago(profile.last_seen) if profile and profile.last_seen else 'Offline'
